...
import { Bell, Search, Map, Plane } from 'lucide-react';
      ...
      <header className="sticky top-0 bg-surface-950/80 backdrop-blur-xl border-b border-surface-800 px-4 py-3 z-40">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link href="/app/heatmap" aria-label="Heatmap" className="p-1.5 text-surface-400 hover:text-white transition-colors">
              <Map className="w-5 h-5" />
            </Link>
            <Link href="/app/flights" aria-label="Flights" className="p-1.5 text-surface-400 hover:text-white transition-colors">
              <Plane className="w-5 h-5" />
            </Link>
            <Link href="/app/drivers" aria-label="Drivers" className="p-1.5 text-surface-400 hover:text-white transition-colors">
              <Search className="w-5 h-5" />
            </Link>
            <Link href="/app/notifications" aria-label="Notifications" className="p-1.5 text-surface-400 hover:text-white transition-colors relative">
